...
<div
	class="group/item flex h-10 w-full cursor-pointer select-none items-center rounded-xl px-2 text-left text-sm font-normal text-gray-700 outline-hidden transition-colors duration-75 hover:bg-gray-50/40 dark:text-gray-100 dark:hover:bg-gray-800/40 [&_button:hover]:bg-transparent! dark:[&_button:hover]:bg-transparent! {selected
